...
export async function requireAuth(req) {
  ...
  // Spindletap staff are always allowed; anyone else must be on the shared
  // allowlist, tagged for the Calendar. Domain is checked first, so a Notion
  // outage can never lock staff out.
  if (domain === ALLOWED_DOMAIN) return email
